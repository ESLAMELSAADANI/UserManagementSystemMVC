...
namespace Day06_Demo.Models
{
    public class User
    {
        ...
        [Remote("UserNameExist", "user", AdditionalFields = "Id", ErrorMessage = "UserName Exist In DB!")]
        ...
        [Remote("EmailExist", "user", AdditionalFields = "Id", ErrorMessage = "Email Exist In DB!")]
